    ...
    <header className='fixed left-0 w-full py-8 z-10 text-white'>
      <div className='container mx-auto flex justify-between items-center'>
        ...
        <div className='flex items-center gap-6'>
          <Link className="bg-gray-300 hover:bg-amber-600 px-4 py-3 rounded-lg transition" to="">Became a host</Link>
          <Link className="bg-gray-300 hover:bg-amber-600 px-4 py-3 rounded-lg transition" to="">Log in</Link>
